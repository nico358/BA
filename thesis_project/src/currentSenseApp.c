...
int8_t init_platform(void)
{
    ...
    return adapter_init_PAC1720(&dev_USB_MON, name_USB_MON, name_CH1_USB_MON, name_CH2_USB_MON, &i2c_interface, ext_delay_func, addr_USB_MON, resistance_CH1_USB_MON, resistance_CH2_USB_MON, channels_USB_MON);
