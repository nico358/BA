...
void init_platform(void)
{
    ...
    adapter_init_PAC1720(&dev_USB_MON, name_USB_MON, name_CH1_USB_MON, name_CH2_USB_MON, &i2c_interface, ext_delay_func , addr_USB_MON, channels_USB_MON);
    adapter_init_PAC1720(&dev_FPGA_VCC, name_FPGA_VCC, name_CH1_FPGA_VCC, name_CH2_FPGA_VCC, &i2c_interface, ext_delay_func , addr_FPGA_VCC, channels_FPGA_VCC);
    adapter_init_PAC1720(&dev_WIREL_MCU, name_WIREL_MCU, name_CH1_WIREL_MCU, name_CH2_WIREL_MCU, &i2c_interface, ext_delay_func, addr_WIREL_MCU, channels_WIREL_MCU);
}
