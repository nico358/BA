...
//     // Declare test- device struct
//     struct PAC1720_device dev;
//     /* Check nullpointer fail */
//     TEST_ASSERT_EQUAL(PAC1720_FAILURE, init_device_PAC1720(&dev));
//     /* TODO check functions called */
//     dev.write = (void*) &dummy_func;
//     dev.read = (void*) &dummy_func;
//     dev.delay_ms = (void*) &dummy_func;
//     TEST_ASSERT_EQUAL(PAC1720_OK, init_device_PAC1720(&dev));
// } 
...
void test_device_null_pointer_check(void) {
    ...
    char msg[500];
    // uint8_t x = 0;
    sprintf(msg, "Test: %p %p %p %p\n", &dev, dev.write, dev.read, (void*)0);
